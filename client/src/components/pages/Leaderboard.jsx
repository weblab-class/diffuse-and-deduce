                      ...
                      ([playerId, player], index) => {
                        const bgColor =
                          gameMode === "multi" && index === 0
                            ? "bg-[#cdab31] hover:bg-[#B38600] backdrop-blur-md border-yellow-500/30"
                            : gameMode === "multi" && index === 1
                            ? "bg-[#a29fa5] hover:bg-[#848484] backdrop-blur-md border-gray-400/30"
                            : gameMode === "multi" && index === 2
                            ? "bg-[#764c00] hover:bg-[#5c3b00] backdrop-blur-md border-amber-600/30"
